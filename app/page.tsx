...
{
  id: 2,
  title: "Project Passover {WIP}",
  category: "Audio",
  type: "Lead Sound Design",
  embedUrl:
    "https://w.soundcloud.com/player/?url=https://soundcloud.com/atlasveil/overclocked&color=%23E94E1B&visual=true",
  link: "https://soundcloud.com/atlasveil/overclocked",
  description:
    "Currently leading audio direction. Designing non-linear vehicle engine loops...",
},
  {
    id: 3,
          ...
          <AnimatePresence>
            {filteredProjects.map((project) => (
              <motion.div
                ...
                key={project.id}
                onClick={() => {
                if (project.title === "Sketchbook Vol. 1") {
                setActiveSketchbook(project);
               setCurrentImage(0);
                }
}}
                className="group relative bg-white border border-gray-300 hover:border-blue-500 transition-colors duration-300 flex flex-col"
              ...
              >
                ...
                <div className="aspect-video w-full bg-gray-200 overflow-hidden relative">
                  {/* LOGIC: Check for Embed URL first, then Image */}
                  {project.embedUrl ? (
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                    ...
                    {project.link && project.link !== "#" && (
                      <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-orange-600 hover:text-black transition-colors">
  ...
  {activeSketchbook && (
    ...
    >
      <motion.div
        ...
        exit={{ scale: 0.9, y: 20 }}
        onClick={(e) => e.stopPropagation()}
        className="bg-[#FDFCF0] w-full max-w-4xl border-2 border-[#2A2A2A] shadow-[8px_8px_0px_#0044CC] overflow-hidden"
      >
        {/* Window Bar */}
